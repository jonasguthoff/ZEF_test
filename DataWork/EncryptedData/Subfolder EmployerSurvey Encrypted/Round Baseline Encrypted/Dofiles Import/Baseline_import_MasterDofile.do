   ...
   * ***************************************************** *
       ...
       *do "$Baseline_doImp/dofile1.do" //Give your dofile a more informative name, this is just a placeholder name
   ...
   * ***************************************************** *
       ...
       *do "$Baseline_doImp/dofile2.do" //Give your dofile a more informative name, this is just a placeholder name
   ...
   * ***************************************************** *
       ...
       *do "$Baseline_doImp/dofile3.do" //Give your dofile a more informative name, this is just a placeholder name
